...
public static class ValePedagioProviderCatalog
{
    ...
    [
        ...
        new(ValePedagioProviderType.DBTrans, "DBTrans", 1, [ValePedagioCapability.Quote, ValePedagioCapability.Purchase, ValePedagioCapability.Cancel, ValePedagioCapability.Receipt, ValePedagioCapability.Retry, ValePedagioCapability.Sync], ValePedagioIntegrationMode.Real),
        new(ValePedagioProviderType.Repom, "Repom", 1, [ValePedagioCapability.Quote, ValePedagioCapability.Purchase, ValePedagioCapability.Cancel, ValePedagioCapability.Receipt, ValePedagioCapability.Retry, ValePedagioCapability.Sync], ValePedagioIntegrationMode.Real),
        new(ValePedagioProviderType.DigitalCom, "DigitalCom", 1, [ValePedagioCapability.Quote, ValePedagioCapability.Purchase, ValePedagioCapability.Cancel, ValePedagioCapability.Receipt, ValePedagioCapability.Callback, ValePedagioCapability.Retry, ValePedagioCapability.Sync], ValePedagioIntegrationMode.Real),
        new(ValePedagioProviderType.Ambipar, "Ambipar", 2, [ValePedagioCapability.Quote, ValePedagioCapability.Purchase, ValePedagioCapability.Cancel, ValePedagioCapability.Receipt, ValePedagioCapability.Retry, ValePedagioCapability.Sync], ValePedagioIntegrationMode.Real),
        new(ValePedagioProviderType.Extratta, "Extratta", 2, [ValePedagioCapability.Quote, ValePedagioCapability.Purchase, ValePedagioCapability.Cancel, ValePedagioCapability.Receipt, ValePedagioCapability.Retry, ValePedagioCapability.Sync], ValePedagioIntegrationMode.Real),
        new(ValePedagioProviderType.Pamcard, "Pamcard", 2, [ValePedagioCapability.Quote, ValePedagioCapability.Purchase, ValePedagioCapability.Cancel, ValePedagioCapability.Receipt, ValePedagioCapability.Callback, ValePedagioCapability.Retry, ValePedagioCapability.Sync], ValePedagioIntegrationMode.Real),
        new(ValePedagioProviderType.QualP, "QualP", 3, [ValePedagioCapability.Quote, ValePedagioCapability.Purchase, ValePedagioCapability.Cancel, ValePedagioCapability.Receipt, ValePedagioCapability.Retry, ValePedagioCapability.Sync], ValePedagioIntegrationMode.Real),
        new(ValePedagioProviderType.SemParar, "SemParar", 3, [ValePedagioCapability.Quote, ValePedagioCapability.Purchase, ValePedagioCapability.Cancel, ValePedagioCapability.Receipt, ValePedagioCapability.Callback, ValePedagioCapability.Retry, ValePedagioCapability.Sync], ValePedagioIntegrationMode.Real),
        new(ValePedagioProviderType.Target, "Target", 3, [ValePedagioCapability.Quote, ValePedagioCapability.Purchase, ValePedagioCapability.Cancel, ValePedagioCapability.Receipt, ValePedagioCapability.Callback, ValePedagioCapability.Retry, ValePedagioCapability.Sync], ValePedagioIntegrationMode.Real),
        new(ValePedagioProviderType.NDDCargo, "NDDCargo", 3, [ValePedagioCapability.Quote, ValePedagioCapability.Purchase, ValePedagioCapability.Cancel, ValePedagioCapability.Receipt, ValePedagioCapability.Callback, ValePedagioCapability.Retry, ValePedagioCapability.Sync], ValePedagioIntegrationMode.Real)
    ];
}
